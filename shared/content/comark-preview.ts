export const comarkPreviewMarkdown = `::hero
---
{
...
---
{
  ...
  "items": [
    {
      "title": "Simple",
      "description": "Pas d'écran complexe, pas d'application obligatoire.",
      "tone": "blue"
    },
    {
      "title": "Inclusif",
      "description": "Accessible aux personnes âgées, aux étudiants internationaux.",
      "tone": "gold"
    },
    {
      "title": "Ludique",
      "description": "Proposer une activité devient un geste léger.",
      "tone": "green"
    }
  ]
}
...
::richtext
## Mentions légales (aperçu)

Ceci est un bloc **richtext** pour la prose libre (mentions, politique, blog).
::
